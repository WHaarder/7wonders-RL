...
def build_card(idx, colour, name, age, cost, players, infostr):
    cardclasses = {
    ...
    card = cardclasses[colour](idx, name, age, cost, players)
...
def read_cards_file(filename):
    ...
    with open(filename) as f:
        ...
        for line in content:
            ...
            text = values[7].strip()
            c = build_card(idx, colour, name, age, cost, players, text)
            if c:
